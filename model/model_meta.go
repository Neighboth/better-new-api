...
type Model struct {
	...
	// DescriptionI18n holds optional per-language descriptions as a JSON
	// object {"tr": "...", "fr": "..."}; Description stays the English base.
	DescriptionI18n string         `json:"description_i18n,omitempty" gorm:"type:text"`
...
// DescriptionI18nMap decodes the per-language description JSON.
func (mi *Model) DescriptionI18nMap() map[string]string {
